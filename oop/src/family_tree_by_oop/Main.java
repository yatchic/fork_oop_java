package family_tree_by_oop;


import family_tree_by_oop.file_maniger.TreeFileManager;
import family_tree_by_oop.order.TreeSorter;
import family_tree_by_oop.query.Query;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
         ...
         Tree<Integer, String, String, Integer, String, Boolean> dogs = new Tree<>();//создается база
